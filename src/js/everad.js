    ...
    function initiate() {
      ...
      function createModalBody(breakpoint) {
        ...
        if (desktop) {
          ...
          document.querySelector(".ever-popup .ever-popup__inner").style.width =
        ...
        if (mobile) {
          ...
          var mobileStyles =
            ".ever-desktop{display: block}.ever-mobile{display: none}@media screen and (max-width: " +
            breakpoint +
      ...
      function addPhoneBtn(breakpoint) {
        ...
        phoneStyles.innerHTML =
          ...
          breakpoint +
          "px) {#clbh_phone_div{display: none !important;}}";
      ...
      function init() {
        ...
        if (desktopPopup || mobilePopup) {
          ...
          document
            .querySelector(".ever-popup__close")
            .addEventListener("click", hidePopup);
          document
            .querySelector(".ever-popup__inner")
            .addEventListener("click", notHide);
          document
            .querySelector(".ever-popup")
            .addEventListener("click", hidePopup);
